<!-- src/components/pods/blog/BlogCardList.vue -->
<template>
            ...
            >
              <div class="relative">
                <img
                  :src="card.img"
                  :alt="card.title"
                  class="w-full h-56 object-cover transition-transform duration-500 ease-out group-hover:scale-105"
                  loading="lazy"
                  decoding="async"
                />
              </div>
              ...
              <div class="px-4 py-4">
                <div class="flex items-center gap-4 text-xs text-slate-500">
                  <span class="inline-flex items-center gap-1">
                    <i class="pi pi-user text-[12px]"></i>{{ card.author || "Arkhan" }}
                  </span>
                  <span class="inline-flex items-center gap-1">
                    <i class="pi pi-calendar text-[12px]"></i
                    >{{ card.date || "May 19, 2024" }}
                  </span>
                </div>

                <h4
                  class="mt-2 text-slate-900 font-semibold leading-snug"
                  style="
                    display: -webkit-box;
                ...
                >
                  {{
                    card.excerpt ||
                    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis ante augue, cursus in nisl quis, ornare posuere turpis. Etiam scelerisque magna in pulvinar semper."
                  }}
                </p>

                <div class="mt-3">
                  <span
                    class="inline-flex items-center gap-1 text-sm font-semibold text-slate-900"
                  >
                    Read More
